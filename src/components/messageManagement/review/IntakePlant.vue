  ...
  <!-- 面包屑---显示当前页面的路径，快速返回之前的任意页面-->
    <div id="title">
      <div class="crumb">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item v-if="rolen !== 'admin'">消纳场申报</el-breadcrumb-item>
          <el-breadcrumb-item v-if="rolen === 'admin'">消纳场管理</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <img src="../../../../static/img/icon26.png" alt="箭头" />
    </div>
    <div id="select">
    <button @click="intakeDialog = true" v-if="rolen !== 'admin'" class="add-btu ml">
        ...
        <el-table-column label="操作" width="200" align="center">
          <template slot-scope="scope">
            ...
            <el-button
              type="text"
              icon="el-icon-eleme"
              @click="getEF(scope.row.intakePlantId)"
              >电子围栏</el-button
            >
            <el-button
              v-if="rolen !== 'admin'"
    ...
    >
      <el-form
        ...
        :inline="true"
      >
        <el-form-item label="消纳厂序号" prop="intakePlantId">
          <el-input v-model="intakeForm.intakePlantId"></el-input>
        </el-form-item>
        <el-form-item label="消纳厂名称" prop="intakePlantName">
          <el-input v-model="intakeForm.intakePlantName"></el-input>
        </el-form-item>
        <el-form-item label="位置" prop="intakePlantAddress">
          <el-input v-model="intakeForm.intakePlantAddress"></el-input>
        </el-form-item>
        <el-form-item label="经度" prop="intakePlantLong">
          <el-input v-model="intakeForm.intakePlantLong"></el-input>
        </el-form-item>
        <el-form-item label="纬度" prop="intakePlantLat">
          <el-input v-model="intakeForm.intakePlantLat"></el-input>
        </el-form-item>
        <el-form-item label="备注" prop="content">
          <el-input v-model="intakeForm.content"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="success" @click="efDialog = true">设置电子围栏</el-button>
    ...
    >
      <el-form :model="intakeForm2" :inline="true">
        ...
        <el-form-item label="审核状态">
          ：&nbsp;&nbsp;
          <span style="color: red" v-if="intakeForm2.reviewStatus === 0">待审核</span>
          <span style="color: red" v-if="intakeForm2.reviewStatus === 1">审核通过</span>
    ...
    >
      ...
      >
        <el-form-item label="消纳厂序号" prop="intakePlantId">
          <el-input :disabled="true" v-model="intakeForm2.intakePlantId"></el-input>
        </el-form-item>
        <el-form-item label="消纳厂名称" prop="intakePlantName">
          <el-input v-model="intakeForm2.intakePlantName"></el-input>
        </el-form-item>
        <el-form-item label="位置" prop="intakePlantAddress">
          <el-input v-model="intakeForm2.intakePlantAddress"></el-input>
        </el-form-item>
        <el-form-item label="经度" prop="intakePlantLong">
          <el-input v-model.number="intakeForm2.intakePlantLong"></el-input>
        </el-form-item>
        <el-form-item label="纬度" prop="intakePlantLat">
          <el-input v-model.number="intakeForm2.intakePlantLat"></el-input>
        </el-form-item>
        <el-form-item label="备注" prop="content">
          <el-input v-model="intakeForm2.content"></el-input>
        </el-form-item>

        <el-form-item>
          <el-button type="success" @click="efDialog = true">修改电子围栏</el-button>
...
export default{
  data(){
    return {
      ...
      // 表单验证规则
      intakeFormRules: {
        intakePlantId: [{ required: true, message: "不能为空!", trigger: "blur" }],
        intakePlantName: [{ required: true, message: "不能为空!", trigger: "blur" }],
        intakePlantAddress: [{ required: true, message: "不能为空!", trigger: "blur" }],
        intakePlantLong: [
  ...
  methods:{
    ...
    getData2() {
      ...
      if (
        ...
        selectIntakeDataByInputName(this.username)
          .then((res) => {
          ...
          .then(() => {
            ...
            for (let i = 0; i < this.lngList.length; i++) {
              let onedata = {
                id: this.allData[this.allData.length - 1].intakePlantId,
                sorI: 0,
                lng: this.lngList[i],
                lat: this.latList[i],
 ...
 // 前端分页功能
    ...
    addData() {
      // 封装插入的数据
      let data = {
        intakePlantId: this.intakeForm.intakePlantId,
    ...
    getUpdateIntakeId(id) {
      ...
      //渲染电子围栏
      selectByIdAndSOrI(0, parseInt(this.intakeForm2.intakePlantId)).then((res) => {
    ...
    updateData() {
      ...
      if (this.isClickChangeEf) {
        ...
        deleteEfData(0, this.intakeForm2.intakePlantId).then(() => {
          // 保存经纬度数据
          // 封装数据
          let data = [];
          for (let i = 0; i < this.lngList.length; i++) {
            let onedata = {
              id: this.intakeForm2.intakePlantId,
              sorI: 0,
              lng: this.lngList[i],
              lat: this.latList[i],
              inputName: window.sessionStorage.namen,
