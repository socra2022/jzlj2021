<template>
  <div>
    ...
    <div id="select">
      ...
      />
      <a id="downlink"></a>
      <el-button class="button" style="margin-left:10vw" @click="uploadFile()"
        >批量导入</el-button
      >
      <!--错误信息提示-->
      <el-dialog title="提示" v-model="errorDialog" size="tiny">
        ...
        <span slot="footer" class="dialog-footer">
          <el-button type="primary" @click="errorDialog = false"
            >确认</el-button
          >
        </span>
      </el-dialog>
    ...
    <div id="mytable">
      ...
      >
        ...
        <el-table-column prop="phoneNo" label="SIM卡号"></el-table-column>
        <!-- <el-table-column
          prop="terminalId"
          label="终端编号"
          width="150"
        ...
        <el-table-column prop="loadCapacity" label="定载重量(吨)"></el-table-column>
        ...
        <el-row :gutter="25">
          <el-col :span="12" :offset="1">
            <el-form-item label="核定载重" prop="loadCapacity">
              <el-input
                v-model="carInfoForm.loadCapacity"
          ...
          <el-col :span="12" :offset="1">
            <el-form-item label="司机名称" prop="driverName">
              <el-input
                v-model="carInfoForm.driverName"
                class="handle-input mr10"
                style="width:300px"
              ></el-input>
            </el-form-item>
          ...
          <el-col :span="12" :offset="1">
            <el-form-item label="sim卡号" prop="phoneNo">
              <el-input
                v-model="carInfoForm.phoneNo"
                class="handle-input mr10"
                style="width:300px"
              ></el-input>
            </el-form-item>
          ...
          <el-col :span="24" :offset="1">
            <el-form-item label="审核状态" prop="reviewStatus">
              <el-radio-group v-model="carInfoForm.reviewStatus">
      ...
      >
        <el-row :gutter="25">
          ...
          <el-col :span="12" :offset="1">
            <el-form-item label="核定载重" prop="loadCapacity">
              <el-input
                v-model="carInfoForm2.loadCapacity"
                class="handle-input mr10"
                style="width:300px"
              ></el-input>
            </el-form-item>
          ...
          <el-col :span="24" :offset="1">
            <el-form-item label="审核状态" prop="reviewStatus">
              <el-radio-group v-model="carInfoForm2.reviewStatus">
                <el-radio :label="0">待审核</el-radio>
                <el-radio :label="1">审核通过</el-radio>
                <el-radio :label="2">审核未通过</el-radio>
              </el-radio-group>
    ...
    >
      <el-form :model="carInfoForm2" :inline="true">
        ...
        <!-- <el-form-item label="密闭装置">
          ：&nbsp;&nbsp;
          <span style="color: red"
            >{{
              carInfoForm2.airtightFlag
            }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span
          >
        </el-form-item> -->
        <!-- <el-form-item label="载重装置">
          ：&nbsp;&nbsp;
          <span style="color: red"
            >{{
              carInfoForm2.capacityFlag
            }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span
          >
        </el-form-item> -->
        <!-- <el-form-item label="举升装置">
          ：&nbsp;&nbsp;
          <span style="color: red"
            >{{
              carInfoForm2.liftFlag
            }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span
          >
        </el-form-item> -->
        <!-- <el-form-item label="防漏装置">
          ：&nbsp;&nbsp;
          <span style="color: red"
            >{{
              carInfoForm2.leakProofFlag
            }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span
          >
        </el-form-item> -->
      ...
      <el-form-item label="燃料类型">
        ...
        <!-- <el-form-item label="准运号牌">
          ：&nbsp;&nbsp;
          <span style="color: red"
            >{{
              carInfoForm2.navicertNo
            }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span
          >
        </el-form-item> -->
        <el-form-item label="准驾车型">
          ...
          <span style="color: red"
            >{{
              carInfoForm2.drivingType
            }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span
          >
        </el-form-item>
        <!-- <el-form-item label="交强险年限">
          ：&nbsp;&nbsp;
          <span style="color: red"
            >{{
              carInfoForm2.insuranceStartTime
            }}-{{
              carInfoForm2.insuranceEndTime
            }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span
          >
        </el-form-item> -->
        ...
        <!-- <el-form-item label="审核状态">
          ：&nbsp;&nbsp;
          <span style="color: red" v-if="carInfoForm2.reviewStatus === 0"
            >待审核</span
          >
          <span style="color: red" v-if="carInfoForm2.reviewStatus === 1"
            >审核通过</span
          >
    ...
    <el-dialog
      ...
      append-to-body
    >
      <el-table :data="excelData" max-height="400">
        <el-table-column
          type="index"
          label="序号"
          align="center"
        ...
        <el-table-column prop="phoneNo" label="sim卡号" width="100"></el-table-column>
        <el-table-column prop="driverName" label="驾驶员姓名"></el-table-column>
        <!-- <el-table-column prop="driverType" label="准驾车型"></el-table-column> -->
        <el-table-column
          prop="carLong"
          label="货箱尺寸(长/米)"
        ></el-table-column>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="dialogTableInsert"
          >确定导入</el-button
        >
      </div>
    </el-dialog>
    ...
    dealFile: function(data) {
      ...
      if (data.length <= 0) {
        ...
        this.excelData = data.map(item => {
          ...
          for (let key in item) {
            //console.log(key);
            arrItem.navicertNo=item.__EMPTY;
            arrItem.carNo = item.__EMPTY_1;
            arrItem.terminalId = item.__EMPTY_2;
            // arrItem.registrationDate=item.__EMPTY_3;
            arrItem.driverName = item.__EMPTY_4;
            arrItem.certNo = item.__EMPTY_5;
            arrItem.drivingType = item.__EMPTY_6;
            // arrItem.driverName = item.__EMPTY_7;
            arrItem.company = item.__EMPTY_8;
            arrItem.carColor = item.__EMPTY_9;
            //arrItem.linkman = item.__EMPTY_18;
            arrItem.carBrand = item.__EMPTY_10;
            arrItem.carType = item.__EMPTY_11;
            arrItem.fuelType = item.__EMPTY_12;
            arrItem.emissionStandard = item.__EMPTY_13;
            arrItem.insuranceCompany = item.__EMPTY_14;
            arrItem.transportLicense = item.__EMPTY_15;
            arrItem.phoneNo = item.__EMPTY_19;
            // arrItem.capacityFlag = item.__EMPTY_21;
            arrItem.carLong = item.__EMPTY_24;
            arrItem.carWidth = item.__EMPTY_25;
            arrItem.carHigh = item.__EMPTY_26;
            arrItem.loadCapacity = item.__EMPTY_27;
            arrItem.inputName = this.$user.getInfo().id;
            arrItem.inputTime = this.$moment().format("YYYY-MM-DD HH:mm:ss");

//              __EMPTY: "准运号牌"navicertNo
// __EMPTY_1: "车牌号码"    2020.09.09
// __EMPTY_2: "SIM卡号"
// __EMPTY_3: "注册日期"
// __EMPTY_4: "驾驶员姓名"
// __EMPTY_5: "身份证号码"
...
// __EMPTY_13: "排放标准"
// __EMPTY_14: "保险公司"
// __EMPTY_15: "道路运输证号"transportLicense
// __EMPTY_16: "发动机号"
// __EMPTY_17: "车架号"
// __EMPTY_18: "车辆所有人"
// __EMPTY_19: "车辆所有人联系电话"
// __EMPTY_20: "密闭装置"
// __EMPTY_21: "载重装置"
// __EMPTY_22: "举升装置"
// __EMPTY_23: "防漏装置"
...
// __EMPTY_27: "核定载重量(吨)"
            // if (key === '车牌号码') {
            //   arrItem.carNo = item[key]
            // } else if (key === 'SIM卡号') {
            //   arrItem.phoneNo = item[key]
            // } else if (key === '驾驶员姓名') {
            //   arrItem.driverName = item[key]
            // } else if (key === '所属企业') {
            //   arrItem.company = item[key]
            // } else if (key === '车辆所有人') {
            //   arrItem.linkman = item[key]
            // }else if (key === '车辆型号') {
            //   arrItem.carType = item[key]
            // }
            // else if (key === '货箱尺寸(长/米)') {
            //   arrItem.carLong = item[key]
            // }
            // else if (key === '货箱尺寸(宽/米)') {
            //   arrItem.carWidth = item[key]
            // }
            // else if (key === '货箱尺寸(高/米)') {
            //   arrItem.carHigh = item[key]
            // }
            // else if (key === '核定载重量(吨)') {
            //   arrItem.loadCapacity = item[key]
            // }
          }
          // console.log(arrItem);
          return arrItem;
        ...
        //insertExcelCarData(this.excelData)
      }
    },
    dialogTableInsert() {
    ...
    handleSizeChange(val) {
      ...
      // 改变每页显示条数时请求数据
      selectAllCarDataByPage(true, this.currentPage, this.PageSize).then(
        res => {
          //console.log(res);
          this.allData = JSON.parse(JSON.stringify(res.data.respBody.records));
          this.tableData = JSON.parse(JSON.stringify(this.allData));
    ...
    updateData() {
      ...
      let data = {
        ...
        inputName: this.$user.getInfo().id,
        inputTime: this.$moment().format("YYYY-MM-DD HH:mm:ss"),
        reviewStatus: this.carInfoForm2.reviewStatus
      };
      // console.log(data);
      updateCarData(data)
        .then(() => {
    ...
    // 更改审核状态
    review() {
      updateCarReviewStatus(this.currentCarId, this.reviewStatusRadio)
        .then(() => {
          this.$message({
            message: "修改成功！",
            type: "success",
  ...
  watch: {
    select_carNo: function() {
      ...
      //let input3 = this.select_terminalId;
      let table = [];
      for (let i = 0; i < this.tableData.length; i++) {
        if (this.tableData[i].carNo.toString().indexOf(input2) != -1) {
          //if (this.tableData[i].terminalId.toString().indexOf(input3) != -1) {
