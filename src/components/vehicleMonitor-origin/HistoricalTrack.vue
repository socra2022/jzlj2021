    ...
    <div id="map">
      ...
      <div id="historyTable">
        <el-table :data="trail" height="250" border style="width: 100%" highlight-current-row @current-change="handleCurrentChange" ref="canvasTable">
          ...
          <el-table-column prop="trailId" label="轨迹编号" align="center">
          </el-table-column>
          <el-table-column prop="carId" label="车牌号" align="center">
          </el-table-column>
          <el-table-column prop="speed" label="速度" align="center">
          </el-table-column>
          <el-table-column prop="carLong" label="经度" align="center">
          </el-table-column>
          <el-table-column prop="carLat" label="纬度" align="center">
          </el-table-column>
          <el-table-column prop="inputTime" label="采集时间" align="center">
